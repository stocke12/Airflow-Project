...
class StageToRedshiftOperator(BaseOperator):
    ...
    def __init__(self,
        ...
        Arg(s):
            ...
            render_s3_key (True or False): Legacy flag, native rendering is handled by template_fields
    ...
    def execute(self, context):
        ...
        # get aws credentials
        aws_conn = AwsHook(aws_conn_id=self.aws_credentials_id) 
        aws_credential_obj = aws_conn.get_credentials() 

        # get redshift connection
        redshift_conn = PostgresHook(postgres_conn_id=self.redshift_conn_id)

        # Airflow automatically renders s3_key via template_fields before this method runs
        ...
        # issue command
        logging.info(f'Copying data from {s3_path} to Redshift table {self.target_table} ...')
