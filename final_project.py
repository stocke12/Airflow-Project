...
# NOTE: Update this variable if you want to pull data from your personal replicated bucket
# instead of the public Udacity bucket to bypass timeout discovery loops.
...
default_args = {
    ...
    'start_date': datetime(2018, 11, 1), # Data only exists for Nov 2018
    'catchup': True,
...
### Sync operator to make sure all tables are created
...
metric_dict = {
    'not_null': [
        {'table': 'songplays', 'columns': ['playid', 'start_time', 'userid']},
    ...
    'row_count': [
        {'table': 'songplays', 'min': 1, 'max': None},
...
start_operator >> [
    ...
    create_artists, create_songs, create_time, create_users
] >> sync_operator_1
